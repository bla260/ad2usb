...
Walk Test Mode On | Detect when a user has entered (enabled) TEST mode. You can detect this for any user or a specific user. | Unknown | Yes (3.3.4 and above)<br/>[Verified]
Walk Test Mode Off | Detect when a user has exited TEST mode. You can detect this for any user or a specific user. | Unknown | Yes (3.3.4 and above)<br/>[Verified]
